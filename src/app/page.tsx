export default function RootPage() {
  return (
    <main className="flex flex-col items-center justify-between pt-4 md:p-4 lg:p-12 xl:p-20 md:text-lg lg:text-xl xl:text-2xl">
       ...
       <br></br> &nbsp; <br></br>
       <h2> Starter Pax is a curated collection of high value starter items, or &quot;starter packs&quot;, for various hobbies and needs. </h2> <br></br>
       <br></br> &nbsp; <br></br>
       <h3> Select one of the categories above </h3>
       <br></br> &nbsp; <br></br>
         
       We&apos;ve spent time researching and experiencing these hobbies or lifestyle categories to find the best items to get you started quickly.
       ...
       We have no affiliation or sponsorship with any of the items listed. <br></br>
    </main>
  );
}
